            ...
            <center><h1><strong>JOB SCRAPPER</strong></h1>
                ...
                <center>
                    <form method="get" action="index.jsp">
                        ...
                        <button type="button" class="btn btn-success" id="btn"><span class="glyphicon glyphicon-export" ></span></button>
                    </form>
                    </div>
                    <table class="table table-striped table table-bordered">
                        ...
                        <%
                            ...
                            String regEx = "<img src=\"(.*?)\"(.*?)<h4 class='title changefont'>(.*?)<img(.*?)</h4>(.*?)<p class(.*?)>(.*?)</p>(.*?)<span class=\"text-error\">Deadline:(.*?)</span></p>";
                            Pattern p = Pattern.compile(regEx);
                            Matcher m = p.matcher(content);
                            while (m.find()) {
                                i++;
                                ...
                                jobs.append(m.group(1)+m.group(5)+m.group(7)+"\r\n");*/
                        ...
                        <tr>
                            <td><%out.println("" + i);%></td>
                            <td><%out.println(m.group(3));%></td>
                            <td><img src="<%=img%>"><br/><%out.println(m.group(7));%></td>
                            <td><%out.println(m.group(9));%></td>
                        </tr>
                        <%
